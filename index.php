...
<html lang="en" class="h-100" data-bs-theme="auto">
  ...
  <main class="px-3 container-md">
    <h1>About CitiFeed?.</h1>
    <p class="lead">As governments strive for transparency and inclusivity, effective citizen feedback systems are crucial for bridging the gap between the public and decision-makers. And this has been made possible through CitiFeed!</p>
    <p class="lead">
      <a href="#" class="btn btn-lg btn-light fw-bold border-white bg-white">Get Started</a>
    </p>
  </main>

  <footer class="mt-auto text-white-50">
    <p>Citifeed<a href="https://getbootstrap.com/" class="text-white ms-2">Designed</a>, By <a href="https://twitter.com/mdo" class="text-white">@lance</a>.</p>
  </footer>
</div>
